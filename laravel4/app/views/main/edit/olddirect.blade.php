...
@else
    {{ Form::open(['url' => route( 'olddirect.update', $data['id'] )]) }}
@endif
<div class="contents_base">
            ...
            <div class="table_base2">
                    <table border="0" cellpadding="5" cellspacing="1" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <td class="td_4">売契No.</td>
                                <td class="td_6">{{ Form::text("no", Input::old("no", $data['no'])) }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
    ...
    <tbody><tr>
        ...
        @if ( $data['id'] != '' )
            <input  type="submit"
            onClick="if(window.confirm('削除してもよろしいですか?')){form.action='{{ route('olddirect.delete', $data['id']) }}';return true} else {return false}" value="削除" />
        @endif
        </div>
        </td>
        ...
        <td valign="top" width="50%">
            <div class="listBtn">
                ...
                @if ( $data['id'] != '' )
                <input  type="submit" onClick="form.action='{{ route('olddirect.create') }}';return true" value="複製" />
