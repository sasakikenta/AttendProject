            ...
            <div class="table_base2">
                    <table border="0" cellpadding="5" cellspacing="1" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <td class="td_4">発注</td><td class="td_6"></td>
                            </tr>
                            <tr>
        ...
        <td valign="top" width="50%">
            <div class="table_base2">
                <table border="0" cellpadding="5" cellspacing="1" width="100%">
                        <tbody>
                            <tr>
                                <td class="td_4" width="50%">発注先</td><td class="td_6"></td>
                            </tr>
                            <tr>
                                <td class="td_4">発注元</td><td class="td_6"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td class="td_4">集金済</td><td class="td_6"></td>
                            </tr>
                            <tr>
